      ...
      <div className="flex item-center justify-between h-16">
        <div className="flex">
          ...
          <div className="flex-shrink-0 flex items-center pl-5 ">
            <Link to={"/"}>
            <img className="hidden lg:block h-10 w-40" src={messhoLogo} alt="Meesho" />
            </Link>
          </div>

          {/* Search Bar */}

          <div className='relative shrink h-10 flex items-center justify-center mt-4 xl:ml-15 ml-5 border border-gray-500 rounded-md '>
            <CiSearch className='absoute ml-3 xl:w-10 xl:h-7 h-4 w-6 text-left text-gray-500 '/>
            <input className='xl:w-96 lg:w-72 w-60 sm:w-48  h-8  text-base items-center justify-center flex mt border-none outline-none pl-1'
             type="text"
            ...
            <div className="absolute top-12 left-0 w-full bg-white border border-gray-500 text-black z-40">
              <ul>
        ...
        <div className='relative   flex items-center justify-between mx-6'>
            ...
            <TfiMobile className='mr-1 text-md mt-1  '/>
           ...
           {isOpen &&(
            ...
            <span className='text-md '>Become a Supplier </span>
            <div className='w-0.5 h-10 bg-[#cecede] rounded-sm'></div>
            <span className='text-md'>Newsroom</span>
            <div className='w-0.5 h-10 bg-[#cecede] rounded-sm'></div>
            </div>
            </div>
